...
function ProfileComponent_ng_template_172_Template(rf, ctx) { if (rf & 1) {
...
function ProfileComponent_ng_template_176_option_84_Template(rf, ctx) { if (rf & 1) {
...
function ProfileComponent_ng_template_176_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ProfileComponent_ng_template_176_Template_form_ngSubmit_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.onAddRowSave(ctx_r5.register); });
...
ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProfileComponent, selectors: [["app-profile"]], viewQuery: function ProfileComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"]])], decls: 179, vars: 4, consts: [[1, "main-content"], [1, "breadcrumb", "breadcrumb-style"], [1, "breadcrumb-item"], [1, "page-title", "m-b-0"], [1, "breadcrumb-item", "bcrumb-1"], ["routerLink", "/dashboard/main"], [1, "fas", "fa-home", "font-17"], [1, "section-body"], [1, "row", "mt-sm-4"], [1, "col-12", "col-md-12", "col-lg-4"], [1, "card", "author-box"], [1, "card-body"], [1, "author-box-center"], ["alt", "image", "src", "assets/images/users/user-1.png", 1, "rounded-circle", "author-box-picture"], [1, "clearfix"], [1, "author-box-name"], ["href", "#", "onClick", "return false;"], [1, "author-box-job"], [1, "text-center"], [1, "author-box-description"], [1, "mb-2", "mt-3"], [1, "text-small", "fw-bold"], ["href", "#", "onClick", "return false;", 1, "btn", "btn-social-icon", "msr-1", "btn-facebook"], [1, "fab", "fa-facebook-f"], ["href", "#", "onClick", "return false;", 1, "btn", "btn-social-icon", "msr-1", "btn-twitter"], [1, "fab", "fa-twitter"], ["href", "#", "onClick", "return false;", 1, "btn", "btn-social-icon", "msr-1", "btn-github"], [1, "fab", "fa-github"], ["href", "#", "onClick", "return false;", 1, "btn", "btn-social-icon", "msr-1", "btn-instagram"], [1, "fab", "fa-instagram"], [1, "w-100", "d-sm-none"], [1, "card"], [1, "card-header"], [1, "py-4"], [1, "float-left"], [1, "float-right", "text-muted", 2, "width", "60%"], [1, "col-12", "col-md-12", "col-lg-8"], [1, "padding-20"], ["ngbNav", "", 1, "nav-tabs", 3, "activeId", "activeIdChange"], ["nav", "ngbNav"], [3, "ngbNavItem"], ["ngbNavLink", ""], ["ngbNavContent", ""], [1, "mt-2", 3, "ngbNavOutlet"], [1, "tab-pane"], [1, "row"], [1, "col-md-3", "col-6", "b-r"], [1, "text-muted"], [1, "col-md-3", "col-6"], [1, "m-t-30"], [1, "register-form", 2, "margin-top", "50px", "border-color", "rgb(20, 20, 20)", "border", "black", 3, "formGroup", "ngSubmit"], [1, "row", 2, "margin-left", "20px", "margin-right", "20px", "border", "black"], [1, "col-md-12"], [1, "col-md-6"], [1, "form-group", "position-relative"], ["name", "user", 1, "login-icons", "pt-1", 2, "color", "rgb(63, 89, 241)"], ["type", "text", "placeholder", "From Phone Book ", "required", "", 1, "form-control", "pl-5"], [1, "col-md-8"], ["name", "", "cols", "30", "rows", "3", 1, "form-control", "pl-2"], ["name", "map-pin", 1, "login-icons", "pt-1", 2, "color", "rgb(63, 89, 241)"], ["type", "text", "placeholder", "Pincode ", "required", "", 1, "form-control", "pl-5"], ["name", "target", 1, "login-icons", "pt-1", 2, "color", "rgb(63, 89, 241)"], ["type", "text", "placeholder", " city/town", "required", "", 1, "form-control", "pl-5"], ["name", "map", 1, "login-icons", "pt-1", 2, "color", "rgb(63, 89, 241)"], ["type", "text", "placeholder", "district", "required", "", 1, "form-control", "pl-5"], ["name", "crosshair", 1, "login-icons", "pt-1", 2, "color", "rgb(63, 89, 241)"], ["type", "text", "placeholder", " state", "required", "", 1, "form-control", "pl-5"], ["name", "smartphone", 1, "login-icons", "pt-1", 2, "color", "rgb(63, 89, 241)"], ["type", "text", "placeholder", " Tele-number", "required", "", 1, "form-control", "pl-5"], ["name", "mail", 1, "login-icons", "pt-1", 2, "color", "rgb(63, 89, 241)"], ["type", "text", "placeholder", " E-Mail", "required", "", 1, "form-control", "pl-5"], ["name", "more-horizontal", 1, "login-icons", "pt-1", 2, "color", "rgb(63, 89, 241)"], ["type", "text", "placeholder", " website link", "required", "", 1, "form-control", "pl-5"], [1, "text-danger"], ["name", "Briefcase", 1, "login-icons", "pt-1", 2, "color", "rgb(63, 89, 241)"], ["required", "", 1, "form-control", "pl-5"], ["value", "", "selected", "", "disabled", ""], [3, "value", 4, "ngFor", "ngForOf"], ["name", "", 1, "login-icons", "pt-1", 2, "color", "rgb(63, 89, 241)"], ["name", "", "cols", "30", "rows", "3", "placeholder", "Type Your BUsiness Keywords ", 1, "form-control", "pl-2"], ["name", "", "cols", "30", "rows", "3", "placeholder", "Type Your Products ", 1, "form-control", "pl-2"], ["name", "", "cols", "30", "rows", "3", "placeholder", "Tyepe Your Needed Contacts ", 1, "form-control", "pl-2"], [1, "col-md-12", 2, "text-align", "center"], ["type", "submit", 1, "btn", "btn-primary"], [3, "value"]], template: function ProfileComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("activeIdChange", function ProfileComponent_Template_ul_activeIdChange_167_listener($event) { return ctx.active = $event; });
        ...
        const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](168);
