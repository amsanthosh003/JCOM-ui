(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~changepassword-changepassword-module~connectentry-connectentry-module~connectpending-connect~f780ee15"], {
    /***/
    "3UD+":
    /*!*******************************************!*\
    ...
    /***/
    function UfF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "isNodeJSEnv", function () {
        return isNodeJSEnv;
      });
      /**
      ...
      var isNodeJSEnv = Object.prototype.toString.call(typeof process !== 'undefined' ? process : 0) === '[object process]'; // Interesting fact:
    ...
    /***/
    function EuKt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "clearAll", function () {
        return clearAll;
      });
      /* harmony import */


      var _is_user_timing_api_supported__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./is-user-timing-api-supported */
      "oyBm");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "isUserTimingAPISupported", function () {
        return _is_user_timing_api_supported__WEBPACK_IMPORTED_MODULE_0__["isUserTimingAPISupported"];
      });
      /* harmony import */


      var _is_performance_observable_supported__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./is-performance-observable-supported */
      "dgof");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "isPerformanceObservableSupported", function () {
        return _is_performance_observable_supported__WEBPACK_IMPORTED_MODULE_1__["isPerformanceObservableSupported"];
      });
      /* harmony import */


      var _is_nodejs_env__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./is-nodejs-env */
      "5UfF"); // Map() is not used in order to decrease the bundle
      ...
      var getTimeNow = function getTimeNow() {
        return _is_user_timing_api_supported__WEBPACK_IMPORTED_MODULE_0__["isUserTimingAPISupported"] ? performance.now() : Date.now();
      };
      /**
        ...
        if (_is_user_timing_api_supported__WEBPACK_IMPORTED_MODULE_0__["isUserTimingAPISupported"]) {
          if (_is_nodejs_env__WEBPACK_IMPORTED_MODULE_2__["isNodeJSEnv"] && _is_performance_observable_supported__WEBPACK_IMPORTED_MODULE_1__["isPerformanceObservableSupported"]) {
            ...
            var obs = new PerformanceObserver(function (list) {
              marksObserver[markName] = list.getEntries().find(function (f) {
                return f.name === markName;
              });
              obs.disconnect();
            });
            obs.observe({
      ...
      var end = function end(markName, markNameToCompare) {
        try {
          ...
          if (!markNameToCompare) {
            performance.mark("".concat(markName, "-end"));
          }

          performance.measure(markName, markName, markNameToCompare || "".concat(markName, "-end"));
          ...
          clear(markNameToCompare || "".concat(markName, "-end"));
        }
      };
      /**
    ...
    /***/
    function QOJq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      (function (module) {
        /* harmony import */
        var _is_nodejs_env__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ./is-nodejs-env */
        "5UfF");

        if (_is_nodejs_env__WEBPACK_IMPORTED_MODULE_0__["isNodeJSEnv"] && !global.PerformanceObserver && !global.performance && module && typeof module.require === 'function') {
          /**
           * Requires a module which is protected against bundler minification.
           *
           * @param pkg The module path to resolve
           */
          var dynamicRequire = function dynamicRequire(mod, pkg) {
            return mod.require(pkg);
          };

          try {
            // eslint-disable-next-line @typescript-eslint/no-var-requires
            var _dynamicRequire = dynamicRequire(module, 'perf_hooks'),
                _PerformanceObserver = _dynamicRequire.PerformanceObserver,
                _performance = _dynamicRequire.performance;

            global.PerformanceObserver = _PerformanceObserver;
            global.performance = _performance;
          } catch (error) {
            throw new Error("Your NodeJS application doesn't support 'perf_hooks'. ".concat(error));
          }
        }
        /* WEBPACK VAR INJECTION */
    ...
    /***/
    function dgof(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "isPerformanceObservableSupported", function () {
        return isPerformanceObservableSupported;
      });
      /**
    ...
    /***/
    function erbw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _user_timing_api_resolver__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ../user-timing-api-resolver */
      "QOJq");
      /* harmony import */


      var _marks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ../marks */
      "EuKt");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "start", function () {
        return _marks__WEBPACK_IMPORTED_MODULE_1__["start"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "end", function () {
        return _marks__WEBPACK_IMPORTED_MODULE_1__["end"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "clear", function () {
        return _marks__WEBPACK_IMPORTED_MODULE_1__["clear"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "clearAll", function () {
        return _marks__WEBPACK_IMPORTED_MODULE_1__["clearAll"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "isUserTimingAPISupported", function () {
        return _marks__WEBPACK_IMPORTED_MODULE_1__["isUserTimingAPISupported"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "isPerformanceObservableSupported", function () {
        return _marks__WEBPACK_IMPORTED_MODULE_1__["isPerformanceObservableSupported"];
      });
      /***/
    ...
    /***/
    function oyBm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "isUserTimingAPISupported", function () {
        return isUserTimingAPISupported;
      });
      /**
    ...
    /***/
    function xJkR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NGX_SKELETON_LOADER_CONFIG", function () {
        return NGX_SKELETON_LOADER_CONFIG;
      });
      /* harmony export (binding) */
      ...
      var perf_marks_marks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! perf-marks/marks */
      "erbw");
      /* harmony import */
      ...
      var NGX_SKELETON_LOADER_CONFIG = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('ngx-skeleton-loader.config');
      /**
       * @fileoverview added by tsickle
      ...
      var NgxSkeletonLoaderComponent = /*#__PURE__*/function () {
        ...
        function NgxSkeletonLoaderComponent(config) {
          _classCallCheck(this, NgxSkeletonLoaderComponent);

          var _ref = config || {},
              _ref$appearance = _ref.appearance,
              appearance = _ref$appearance === void 0 ? 'line' : _ref$appearance,
              _ref$animation = _ref.animation,
              animation = _ref$animation === void 0 ? 'progress' : _ref$animation,
        ...
        _createClass(NgxSkeletonLoaderComponent, [{
          key: "ngOnInit",
          ...
          value: function ngOnChanges(changes) {
            ...
            */
            function (key) {
              return changes[key] && (changes[key].isFirstChange() || changes[key].previousValue === changes[key].currentValue);
            })) {
              return;
            }
      ...
      NgxSkeletonLoaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgClass"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgStyle"]],
      ...
      NgxSkeletonLoaderComponent.ctorParameters = function () {
        return [{
          type: undefined,
          decorators: [{
      ...
      var NgxSkeletonLoaderModule = /*#__PURE__*/function () {
        function NgxSkeletonLoaderModule() {
          _classCallCheck(this, NgxSkeletonLoaderModule);
        }

        _createClass(NgxSkeletonLoaderModule, null, [{
          key: "forRoot",
          value:
          /**
           * @param {?=} config
...
//# sourceMappingURL=default~changepassword-changepassword-module~connectentry-connectentry-module~connectpending-connect~f780ee15-es5.js.map